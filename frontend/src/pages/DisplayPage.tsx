            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-left text-base md:text-lg text-gray-100 max-w-5xl mx-auto">
              <ul className="space-y-4 list-none pl-0">
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl mt-0.5 select-none">🎯</span>
                  <div>
                    <strong className="text-blue-300">ĐOÁN TÊN BÀI HÁT:</strong> Các thành viên trong đội phối hợp đoán chính xác tên bài hát.
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="text-2xl mt-0.5 select-none">🎤</span>
                  <div>
                    <strong className="text-blue-300">LƯỢT LIVE CUỐI (LIVE HUMMING):</strong> 1 thành viên lên sân khấu ngân nga trực tiếp.
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm text-gray-300">
                      ...
                      <li>Đoán sai hoặc bỏ qua: <strong className="text-gray-400">Không bị trừ điểm</strong> (không cướp điểm, không gợi ý, được quyền bỏ qua).</li>
                    </ul>
                  </div>
                </li>
              </ul>
              <ul className="space-y-4 list-none pl-0">
                <li className="flex items-start gap-4">
                  <span className="text-2xl mt-0.5 select-none">⏱️</span>
                  <div>
                    <strong className="text-blue-300">4 VÒNG CLIP QUAY SẴN (30S):</strong> Đội thi có <strong className="text-yellow-400">15 giây</strong> để trả lời.
                    <ul className="list-disc pl-5 mt-2 space-y-2 text-sm text-gray-300">
                      <li>Trả lời đúng ngay: <strong className="text-green-400">+10 điểm</strong>.</li>
                      <li>Trả lời sai: Nhận 1 gợi ý và có thêm <strong className="text-yellow-400">10 giây</strong> suy nghĩ. Trả lời đúng sau gợi ý được <strong className="text-green-400">+5 điểm</strong>, trả lời sai <strong className="text-red-400">-5 điểm</strong> (hoặc chọn bỏ qua không bị trừ điểm).</li>
